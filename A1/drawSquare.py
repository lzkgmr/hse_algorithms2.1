...
file_path = "C:\\Users\\lzkgm\\c++\\set3_hse_aisd\\A1\\squareNarrow.txt"
file_path2 = 'C:\\Users\\lzkgm\\c++\\set3_hse_aisd\\A1\\squareWide.txt'
...
plt.title("Сравнение отклонений приближенных площедей в широкой и узкой облостях")
